...
[assembly: EdmRelationshipAttribute("Model", "fk_RoleId", "webpages_Roles", System.Data.Metadata.Edm.RelationshipMultiplicity.One, typeof(ScrumPoker.webpages_Roles), "webpages_UsersInRoles", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(ScrumPoker.webpages_UsersInRoles), true)]
...
namespace ScrumPoker
{
    ...
    public partial class webpages_Roles : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Model", "fk_RoleId", "webpages_UsersInRoles")]
        public EntityCollection<webpages_UsersInRoles> webpages_UsersInRoles
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<webpages_UsersInRoles>("Model.fk_RoleId", "webpages_UsersInRoles");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<webpages_UsersInRoles>("Model.fk_RoleId", "webpages_UsersInRoles", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="Model", Name="webpages_UsersInRoles")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class webpages_UsersInRoles : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Model", "fk_RoleId", "webpages_Roles")]
        public webpages_Roles webpages_Roles
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<webpages_Roles>("Model.fk_RoleId", "webpages_Roles").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<webpages_Roles>("Model.fk_RoleId", "webpages_Roles").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<webpages_Roles> webpages_RolesReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<webpages_Roles>("Model.fk_RoleId", "webpages_Roles");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<webpages_Roles>("Model.fk_RoleId", "webpages_Roles", value);
                }
            }
        }
